...
<body>
    <div id="contents">
        ...
        <section class="board">
            <div class="topMenu">
                <div class="category">
                    <h3 class="free" onclick="location.href='index.php'">자유게시판</h3>
                    <h3 class="info" onclick="location.href='community_info.php'"><span id="span">정보게시판</span></h3>
                </div>
                <?php
                # 다음 페이지에서 get으로 type값 받아감
                $url = "./community_newPost.php?type=info";
                ?>
